...
- ***Alternatively:*** A tech savvy friend can help you with setting up the app to save images remotely. To store images remotely (Google Drive) Section 3 (Configuration Section) in the settings will need to be filled out. Tip: place the credentials in a csv file and upload them into the app.. See next section
