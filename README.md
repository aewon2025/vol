...
- ***Alternatively:*** A tech savvy friend can help you with setting up the app to save images remotely. To store images remotely to Google Drive, Section 3 (Acount Configuration) in the settings will need to be filled out. Tip: place the credentials in a csv file and upload them into the app.. See next section. Note: Switch Storage Mode from Local to Remote in other to view the Private / Team account configuration section
